...
## 7. Always make sure the UI changes that you make are reponsive for desktop and mobile screens

---

## 8. Always refer to `@docs/PRD1.md` and `@docs/techstack.md` for project details.
...
## 11. Always commit and push to dev branch
