...
- Name: apps/web-e2e/src/sow-template-builder.spec.ts >> SOW template builder >> switches to the live preview and renders the generated form
- Location: apps/web-e2e/src/sow-template-builder.spec.ts:27:7
