...
- Name: apps/web-e2e/src/admin-templates.spec.ts >> admin templates page >> archives a template via the active toggle
- Location: apps/web-e2e/src/admin-templates.spec.ts:55:7
