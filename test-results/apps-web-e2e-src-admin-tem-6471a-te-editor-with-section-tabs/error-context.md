...
- Name: apps/web-e2e/src/admin-templates.spec.ts >> admin templates page >> opens the rich text template editor with section tabs
- Location: apps/web-e2e/src/admin-templates.spec.ts:10:7
