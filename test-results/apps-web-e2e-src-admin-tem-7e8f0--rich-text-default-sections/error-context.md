...
- Name: apps/web-e2e/src/admin-templates.spec.ts >> admin templates page >> creates a template with rich text default sections
- Location: apps/web-e2e/src/admin-templates.spec.ts:34:7
