...
- Name: apps/web-e2e/src/admin-workflows.spec.ts >> admin workflows page >> toggles a workflow active state
- Location: apps/web-e2e/src/admin-workflows.spec.ts:53:7
