...
- Name: apps/web-e2e/src/sow-template-builder.spec.ts >> SOW template builder >> shows the generated JSON Schema for a new field
- Location: apps/web-e2e/src/sow-template-builder.spec.ts:36:7
