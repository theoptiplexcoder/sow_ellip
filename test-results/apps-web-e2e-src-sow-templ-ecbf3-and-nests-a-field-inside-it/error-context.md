...
- Name: apps/web-e2e/src/sow-template-builder.spec.ts >> SOW template builder >> adds a Section container and nests a field inside it
- Location: apps/web-e2e/src/sow-template-builder.spec.ts:20:7
