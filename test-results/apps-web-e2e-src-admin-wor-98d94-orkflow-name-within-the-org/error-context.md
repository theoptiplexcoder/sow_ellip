...
- Name: apps/web-e2e/src/admin-workflows.spec.ts >> admin workflows page >> rejects a duplicate workflow name within the org
- Location: apps/web-e2e/src/admin-workflows.spec.ts:41:7
