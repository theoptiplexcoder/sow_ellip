...
export function DialogContent({
  ...
  return (
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content
        className={cn(
          'fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-[calc(100vw-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-lg border border-border bg-card p-6 shadow-lg focus:outline-none',
          className,
        )}
      >
